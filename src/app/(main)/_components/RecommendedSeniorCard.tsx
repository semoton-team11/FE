...
export default function RecommendedSeniorCard({
  ...
  const avatarVariant = senior ? getAvatarVariantForId(senior.id) : { bg: "#FCF1F1", stroke: "#9A001F" };
    ...
    >
      ...
      {isZeroState ? (
        ...
        <div className="flex flex-col items-center flex-1 justify-center gap-4 text-center">
          <div style={{ width: "64px", height: "64px", borderRadius: "50%", backgroundColor: "#FFFFFF", display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      {isZeroState && (
        <Link href="/seniors">
          <button
            style={{ width: "100%", border: "2px solid rgba(154,0,31,0.15)", borderRadius: "16px", height: "56px", fontSize: "14px", fontWeight: 700, color: "#9A001F", backgroundColor: "transparent", cursor: "pointer", transition: "background-color 150ms ease" }}
              ...
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{
                    ...
                    background: senior.profileImage ? "#F6EBEB" : avatarVariant.bg,
                  }}
                >
                  {senior.profileImage ? (
                    <img src={senior.profileImage} alt={senior.name} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                  ) : (
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke={avatarVariant.stroke} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
