    ...
    >
      ...
      <div
        style={{
          width: "100%",
          aspectRatio: "3 / 2.6",
          backgroundColor: senior.profileImage ? "#D1D5DB" : avatarVariant.bg,
          borderRadius: "20px",
          overflow: "hidden",
          display: "flex",
          alignItems: "center",
      ...
      >
        {senior.profileImage ? (
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 24 24" fill="none" stroke={avatarVariant.stroke} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
        <h1 style={{ fontSize: "26px", fontWeight: 700, color: "#1F1A1A" }}>
          {senior.name}
        </h1>
        <button
          style={{
      ...
      <div style={{ display: "flex", gap: "10px", alignItems: "flex-start" }}>
        <svg width="28" height="20" viewBox="0 0 30 22" fill="#D1D5DB">
        ...
        <p style={{ fontSize: "14px", color: "#5C3F3F", lineHeight: 1.7 }}>
          {senior.bio}
        </p>
      </div>
